...
class ABST_Plugin_Updater {
	...
	public function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
		 ...
		 */
		do_action( 'post_ABST_Plugin_Updater_setup', $edd_plugin_data );
	 ...
	 *
	 * @see ABST_Plugin_Updater::request_recently_failed
	 *
	 * @since 1.9.1
	 */
	...
	private function get_version_from_remote() {
		 ...
		 */
		$api_params = apply_filters( 'ABST_Plugin_Updater_api_params', $api_params, $this->api_data, $this->plugin_file );
