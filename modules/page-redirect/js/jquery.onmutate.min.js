...
(function($) {
	...
	$(document).onCreate('.bt-ab-page-redirect', function() 
	{
		 var select = $('.bt-ab-page-redirect select'),
		 	 option_html = '<option></option>',
		 	 value = select.attr('bt-rid');

		option_html += bt_gutenberg_ab_redirect.option_html;
